...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
          String query = "SELECT s.sname,COUNT(s.sid) as total_Parts FROM Catalog c , Suppliers s WHERE s.sid = c.sid GROUP BY s.sname";
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT s.sname,COUNT(s.sid) as total_Parts FROM catalog c, suppliers s WHERE s.sid = c.sid GROUP BY s.sname HAVING COUNT(s.sid) >= 3";
   ...
   public static void Query3(EmbeddedSQL esql){
      try{
         String query = "SELECT s.sname , COUNT(s.sid) as total_Parts FROM catalog c , suppliers s , parts p WHERE s.sid = c.sid AND p.pid = c.pid GROUP BY s.sname HAVING EVERY(p.color = 'Green')";
   ...
   public static void Query4(EmbeddedSQL esql){
      try{
         String query = "SELECT s.sname , MAX(c.cost) as Max_cost FROM catalog c , suppliers s , parts p WHERE s.sid = c.sid and p.pid = c.pid and p.color IN ('Green','Red') GROUP BY s.sname HAVING COUNT( DISTINCT p.color ) = 2";
   ...
   public static void Query5(EmbeddedSQL esql){
      try{
         String query = "SELECT p.pname FROM Catalog c ,Parts p WHERE p.pid = c.pid AND c.cost < ";
         System.out.print("\tEnter cost: $");
         String input = in.readLine();
         query += input;
   ...
   public static void Query6(EmbeddedSQL esql){
      try{
         String query = "SELECT s.address FROM Catalog c, Suppliers  s, Parts p WHERE p.pid = c.pid AND s.sid = c.sid AND p.pname = \'";
         System.out.print("\tParts Name: ");
         String input = in.readLine();  
         query += input + "\'";
